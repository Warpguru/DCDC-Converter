 ...
 *
 * <pre>
 * public static final DeviceRegister VSET = new DeviceRegister("Voltage Setpoint", "V", 0x0000, 100);
 *
 * public static final DeviceRegister ISET = new DeviceRegister("Current Setpoint", "A", 0x0001, 1000);
 * </pre>
 *
 * <p>
 * Usage:
...
public class DeviceRegister {
     ...
     *
     * <p>
     * Every {@link DeviceRegister} instance registers itself here on construction. This allows {@code ModbusTransport} to
     * resolve a raw address to a name for log annotations without any direct coupling to the driver classes.
     * </p>
     */
    ...
    /**
     * Creates a register description with a scale of {@code 1} (no conversion).
     *
     * @param name    Modbus register name
     * @param unit    Modbus register unit
     * @param address Modbus register address
