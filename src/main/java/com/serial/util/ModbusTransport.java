...
public class ModbusTransport {
    ...
    public int readRegister(int reg) throws Exception {
        ...
        frame[0] = ModbusConstants.SLAVE_ADDRESS;
        frame[1] = ModbusConstants.READ_HOLDING_REGISTERS;
        frame[2] = (byte) (reg >> 8);
        frame[3] = (byte) reg;
        frame[4] = 0;
        frame[5] = 1;
     ...
     */
    public void writeRegister(int reg, int value) throws Exception {
        byte[] frame = new byte[8];
        frame[0] = ModbusConstants.SLAVE_ADDRESS;
        frame[1] = ModbusConstants.WRITE_SINGLE_REGISTER;
        frame[2] = (byte) (reg >> 8);
        frame[3] = (byte) reg;
